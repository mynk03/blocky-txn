...
import (
	state "blockchain-simulator/internal/state"
...
func ProcessBlock(block Block, trie *state.MptTrie, stakeAddress common.Address) {
	for _, tx := range block.Transactions {
		...
		// check if the Receiver is stakeAddress or not
		if tx.Receiver == stakeAddress {
