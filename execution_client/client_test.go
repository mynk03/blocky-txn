...
// func (suite *ExecutionClientTestSuite) TestTransactionPropagation3Nodes() {
// 	fmt.Println("\nTesting transaction propagation between three nodes...")
...
// 	addr2 := suite.client2.GetAddress()
// 	err = suite.client3.ConnectToPeer(addr2)
// 	suite.Require().NoError(err, "Failed to connect client3 to client2")
