...
func main() {
	...
	harborServer := execution.NewHarborServer(txPool, chain, validatorAddr.Hex(), logger)

	// Create execution client
	client, err := execution.NewExecutionClient(
		listenAddr,
		txPool,
		chain,
		validatorAddr,
	...
	// Create HTTP server
	httpServer := execution.NewServer(client)
...
func waitForInterrupt(logger *logrus.Logger, client *execution.ExecutionClient) {
